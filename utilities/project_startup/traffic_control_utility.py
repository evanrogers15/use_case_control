...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Start or stop traffic generation on GNS3 nodes.")
    ...
    parser.add_argument("action", choices=["start", "stop"], help="Action to perform on the nodes (start/stop traffic generation).")
